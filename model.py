...
class Net(nn.Module):
    def __init__(self, n_classes,in_channel=1, growth_rate=32, block_config=(6, 12, 24, 16), 
                 num_init_features=64, bn_size=4, drop_rate=0, downsample=False, pretrained_encoder_uri=None, progress=None):
        ...
        self.encoder.features.conv0 = nn.Conv2d(in_channels=in_channel,out_channels=64,kernel_size=(7,7),stride=1,padding=(3,3),bias=False)
